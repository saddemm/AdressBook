...
class appDevDebugProjectContainer extends Container
{
    ...
    protected function getAssetic_AssetManagerService()
    {
        ...
        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\ConfigurationResource(array('jquery_js' => array(0 => array(0 => ($this->targetDirs[2].'/../vendor/components/jquery/jquery.min.js')), 1 => array(0 => '?yui_js'), 2 => array('output' => 'js/jquery.min.js')), 'bootstrap_css' => array(0 => array(0 => ($this->targetDirs[2].'/../vendor/twbs/bootstrap/less/bootstrap.less')), 1 => array(0 => 'lessphp', 1 => 'cssrewrite'), 2 => array('output' => 'css/bootstrap.css')), 'bootstrap_js' => array(0 => array(0 => ($this->targetDirs[2].'/../vendor/twbs/bootstrap/js/affix.js'), 1 => ($this->targetDirs[2].'/../vendor/twbs/bootstrap/js/alert.js'), 2 => ($this->targetDirs[2].'/../vendor/twbs/bootstrap/js/button.js'), 3 => ($this->targetDirs[2].'/../vendor/twbs/bootstrap/js/carousel.js'), 4 => ($this->targetDirs[2].'/../vendor/twbs/bootstrap/js/collapse.js'), 5 => ($this->targetDirs[2].'/../vendor/twbs/bootstrap/js/dropdown.js'), 6 => ($this->targetDirs[2].'/../vendor/twbs/bootstrap/js/modal.js'), 7 => ($this->targetDirs[2].'/../vendor/twbs/bootstrap/js/tooltip.js'), 8 => ($this->targetDirs[2].'/../vendor/twbs/bootstrap/js/popover.js'), 9 => ($this->targetDirs[2].'/../vendor/twbs/bootstrap/js/scrollspy.js'), 10 => ($this->targetDirs[2].'/../vendor/twbs/bootstrap/js/tab.js'), 11 => ($this->targetDirs[2].'/../vendor/twbs/bootstrap/js/transition.js')), 1 => array(0 => '?yui_js'), 2 => array('output' => 'js/bootstrap.js')), 'fonts_glyphicons_eot' => array(0 => array(0 => ($this->targetDirs[2].'/../vendor/twbs/bootstrap/fonts/glyphicons-halflings-regular.eot')), 1 => array(), 2 => array('output' => 'fonts/glyphicons-halflings-regular.eot')), 'fonts_glyphicons_svg' => array(0 => array(0 => ($this->targetDirs[2].'/../vendor/twbs/bootstrap/fonts/glyphicons-halflings-regular.svg')), 1 => array(), 2 => array('output' => 'fonts/glyphicons-halflings-regular.svg')), 'fonts_glyphicons_ttf' => array(0 => array(0 => ($this->targetDirs[2].'/../vendor/twbs/bootstrap/fonts/glyphicons-halflings-regular.ttf')), 1 => array(), 2 => array('output' => 'fonts/glyphicons-halflings-regular.ttf')), 'fonts_glyphicons_woff' => array(0 => array(0 => ($this->targetDirs[2].'/../vendor/twbs/bootstrap/fonts/glyphicons-halflings-regular.woff')), 1 => array(), 2 => array('output' => 'fonts/glyphicons-halflings-regular.woff')))), 'config');
    ...
    {
        $this->services['assetic.filter.cssembed'] = $instance = new \Assetic\Filter\CssEmbedFilter(($this->targetDirs[2].'/Resources/java/cssembed.jar'), 'C:\\Program Files\\Java\\jdk1.8.0_60\\bin\\java.exe');
    ...
    {
        $this->services['assetic.filter.yui_css'] = $instance = new \Assetic\Filter\Yui\CssCompressorFilter(($this->targetDirs[2].'/Resources/java/yuicompressor.jar'), 'C:\\Program Files\\Java\\jdk1.8.0_60\\bin\\java.exe');
    ...
    {
        $this->services['assetic.filter.yui_js'] = $instance = new \Assetic\Filter\Yui\JsCompressorFilter(($this->targetDirs[2].'/Resources/java/yuicompressor.jar'), 'C:\\Program Files\\Java\\jdk1.8.0_60\\bin\\java.exe');
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_edab74bc0edd7be1694269e275da918e48895e9afd0f7c55c105ed2cd0a25278');
    ...
    {
        return $this->services['fos_user.profile.form'] = $this->get('form.factory')->createNamed('fos_user_profile_form', 'UserBundle\\Form\\ProfileType', NULL, array('validation_groups' => array(0 => 'Profile', 1 => 'Default')));
    }
    ...
    {
        return $this->services['fos_user.registration.form'] = $this->get('form.factory')->createNamed('fos_user_registration_form', 'UserBundle\\Form\\RegistrationType', NULL, array('validation_groups' => array(0 => 'Registration', 1 => 'Default')));
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'assetic.filter.cssembed.java' => 'C:\\Program Files\\Java\\jdk1.8.0_60\\bin\\java.exe',
            ...
            'assetic.filter.yui_js.java' => 'C:\\Program Files\\Java\\jdk1.8.0_60\\bin\\java.exe',
            ...
            'assetic.filter.yui_css.java' => 'C:\\Program Files\\Java\\jdk1.8.0_60\\bin\\java.exe',
