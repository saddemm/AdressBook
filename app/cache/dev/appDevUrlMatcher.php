    ...
    public function match($pathinfo)
    {
        ...
        if (0 === strpos($pathinfo, '/profile')) {
            ...
            if (0 === strpos($pathinfo, '/profile/edit') && preg_match('#^/profile/edit/(?P<id>[^/]++)$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'fos_user_profile_edit')), array (  '_controller' => 'UserBundle\\Controller\\ProfileController::editAction',));
            }
        ...
        // index
        if ($pathinfo === '/home') {
            return array (  '_controller' => 'UserBundle\\Controller\\HomeController::indexAction',  '_route' => 'index',);
        }

        // delete
        if (0 === strpos($pathinfo, '/delete') && preg_match('#^/delete/(?P<id>[^/]++)$#s', $pathinfo, $matches)) {
            return $this->mergeDefaults(array_replace($matches, array('_route' => 'delete')), array (  '_controller' => 'UserBundle\\Controller\\HomeController::deleteAction',));
        }
